...
export interface Game {
    ...
    onRyukyoku(type: ryukyoku, tehais: {[key in kaze_number]: number[]}, point: number[]): void
    ...
    onEnd(): void
    onNagashiMangan(kazes: kaze_number[], json: string, json2: string, point: number[]): void
